...
{: #thirdparty }
	...
	En dispositivos iOS y Android, Firefox envía a nuestro proveedor de estadísticas de red móvil los Datos de referencia, incluyendo también la siguiente información: ID del anuncio publicitario de Google, dirección IP, marcas de fecha y hora, país, idioma, sistema operativo y versión de la aplicación. Haga clic [aquí] para obtener más información (https://support.mozilla.org/kb/send-anonymous-usage-data-firefox-mobile-devices). En esta página también podrá encontrar información sobre cómo desactivar el informe.

	En ordenadores de escritorio, Firefox recopila y envía a Mozilla los Datos de referencia como parte del Informe de salud de Firefox.  Haga clic [aquí] para obtener más información (https://support.mozilla.org/kb/desktop-attribution-privacy). En esta página también encontrará las instrucciones para desactivar el informe.
